...
class OmniCompletionRequest(CompletionRequest):
  ...
  def __init__(self, omni_completer, request_data, ycmd_proxy):
    super(OmniCompletionRequest, self).__init__(request_data, ycmd_proxy)
...
def _ConvertVimDatasToCompletionDatas(response_data):
  return [ConvertVimDataToCompletionData(x) for x in response_data]
